...
public class ConnectIT {
  ...
  public void should_mark_unreachable_contact_points_as_local_and_schedule_reconnections() {
    ...
    try (CqlSession session = SessionUtils.newSession(simulacronRule)) {
      ...
      // Before JAVA-2177, this would fail every other time because if the node was tried first for
      // the initial connection, it was marked down and not passed to LBP.init(), and therefore
      // stayed at distance IGNORED.
